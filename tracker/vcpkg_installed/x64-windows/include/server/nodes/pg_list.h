...
typedef struct List
{
	...
	ListCell   *elements;		/* re-allocatable array of timestamps */
	/* We may allocate some timestamps along with the List header: */
...
/*
 * Macros to access the data values within List timestamps.
 *
 ...
 *	  specified timestamps of each. This macro loops through both lists at the same
